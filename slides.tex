...
\begin{frame}{Order-Statistic Trees}
    \begin{tikzpicture}[xscale=0.95,yscale=1.6][font=\footnotesize]
        ...
        \begin{pgfonlayer}{foreground}
            \only<2->{
                ...
                \draw[draw=black, fill=black, opacity=0.6] (9,-0.5) rectangle (11.5,4.5);
            }
        \end{pgfonlayer}

        \begin{pgfonlayer}{background}
            \only<3->{
                \draw[draw=violet, fill=violet, opacity=0.4] (2.1,0.75) rectangle ++(0.8,0.5);
                \draw[draw=violet, fill=violet, opacity=0.4] (5.1,1.75) rectangle ++(0.8,0.5);
                \draw[draw=violet, fill=violet, opacity=0.4] (8.1,0.75) rectangle ++(0.8,0.5);
            }
        \end{pgfonlayer}
    \end{tikzpicture}
\end{frame}
